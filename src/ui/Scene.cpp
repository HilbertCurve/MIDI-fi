...
namespace MidiFi
{
    namespace UI
    {
        // I have no idea how to do oop with c++
        ...
        namespace Scenes
        {
            ...
            Scene debug = 
            {
                []()
                {
                    ...
                    Graphics::initFont(arial, "./assets/fonts/arial-unicode-ms.ttf", 32);
                    ...
                    t2.init({-20, -20 , 0}, {1.0, 0.3, 0.1, 1.0}, 40, 40, "It can support multiple fonts as well, I think...", arial);
